...
<html>
  <head>
    ...
    <title>MSA-TEAM ADMIN Console Page</title>
    ...
    <script>
      (adsbygoogle = window.adsbygoogle || []).push({
        google_ad_client: "ca-pub-8963759299663233",
      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            <div class="logo text-uppercase"><span>MSA-TEAM</span><strong class="text-primary">ADMIN</strong></div>
            <p> MSA ADMIN Login Page </p>
